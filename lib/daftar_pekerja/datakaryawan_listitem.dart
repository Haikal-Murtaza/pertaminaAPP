        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Nama : " + widget.document['nama_karyawan'],
                  style: TextStyle(fontSize: 16),
                ),
                Text(
                  "No ID : " + widget.document['id_karyawan'],
                  style: TextStyle(fontSize: 16),
                ),
                Text(
                ...
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          navToDetailsKaryawan(context, widget.document);
                        },
                        child: Container(
                          height: 30,
                          width: 30,
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: widget.document['profile_picture'] != null
                  ? Image.network(
                      widget.document['profile_picture'],
                      fit: BoxFit.cover,
                      height: 130,
                      width: 130,
                    )
  ...
  Future<User?> findUserByEmail(String email) async {
    try {
      ...
      if (signInMethods.isNotEmpty) {
        // Find the current user with the same email
