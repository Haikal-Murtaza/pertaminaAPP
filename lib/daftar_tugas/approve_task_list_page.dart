...
class ApproveTaskListPage extends StatefulWidget {
  @override
  State<ApproveTaskListPage> createState() => _ApproveTaskListPageState();
}

class _ApproveTaskListPageState extends State<ApproveTaskListPage> {
              ...
              Expanded(
                  child: StreamBuilder<QuerySnapshot>(
                      stream: FirebaseFirestore.instance
                          ...
                          .where('status',
                              whereIn: ['Denied', 'Progress']).snapshots(),
